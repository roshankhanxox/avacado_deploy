...
export function NewRegistration({ onNavigate, mode }: NewRegistrationProps) {
    ...
    useEffect(() => {
        ...
        if (isRegistered && isConnected && !hasRedirectedRef.current && !isRegistering) {
    ...
    const handleGenerateKey = async () => {
        ...
        try {
            ...
            toast.success("Encryption keys generated successfully!", { autoClose: 3000 });
        } catch (error) {
            console.error(error);
                ...
                <AnimatePresence mode="wait">
                    {!isDecryptionKeySet && (
                        ...
                        <p className="text-gray-600 mb-6">
                            Your encryption keys are generated locally in your
                            browser and never leave your device. These keys are
                            used to encrypt and decrypt your private balances.
                        </p>
                ...
                {isDecryptionKeySet && step === "register" && (
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            ...
                            on-chain. This allows others to send you encrypted
                            tokens.
                        </p>
